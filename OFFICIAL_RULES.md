...
**Technological Implementation (25%)** | Does the Project demonstrate quality software development practices?<br>How effectively does the Project leverage the AI Dev Days hero technologies (Microsoft Foundry, Agent Framework, Azure MCP, GitHub Copilot Agent Mode)?<br>Is the code well-structured, documented, and maintainable? |
**Agentic Design & Innovation (25%)** | How creatively does the solution apply Agentic AI patterns?<br>Does the project demonstrate sophisticated agent orchestration, MCP integration, or multi-agent collaboration?<br>Is the AI implementation novel, or does it meaningfully improve upon existing approaches? |
**Real-World Impact & Applicability (25%)** | How significant is the problem being solved?<br>Could this solution be deployed in a production environment?<br>What is the potential impact on developers, businesses, or end users? |
**User Experience & Presentation (25%)** | Is the user experience well-designed and intuitive?<br>Does the demo video clearly communicate the project's value?<br>Is there a balanced blend of frontend and backend implementation? |
...
Personal data you provide while entering this Hackathon will be used by Microsoft and/or its agents and Prize Providers acting on Microsoft's behalf only for the administration and operation of this Hackathon and in accordance with the Microsoft Privacy Statement.
